...
TransformationProgram::TransformationProgram(const HINSTANCE hInstance, const int nCmdShow)
...
void TransformationProgram::cleanResouces()
{
	if(mPVertexBuffer)
...
HRESULT TransformationProgram::initializeResources()
{
...
void TransformationProgram::render()
{
...
void TransformationProgram::keyPressed(WPARAM key, LPARAM param)
{
	switch(key)
	{
...
void TransformationProgram::keyReleased(WPARAM key, LPARAM param)
{
	switch(key)
	{
...
void TransformationProgram::preRender()
{
